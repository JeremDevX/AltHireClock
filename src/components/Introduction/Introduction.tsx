      ...
      <div className={styles.innerContainer}>
        ...
        <div className={styles.textContainer}>
          ...
          <p className={styles.description}>
            ...
            <strong>rigoureux</strong>, même sous pression. <br /> Mais au fil
            du temps, c’est une autre passion qui a pris le dessus :
            l’informatique et le développement web. J’ai donc choisi de me
            reconvertir et j’étudie aujourd’hui à{" "}
            <strong>MyDigitalSchool Grenoble</strong>.
            ...
            <strong>Bac +5 MBA Fullstack</strong>. Jusqu’ici, j’ai surtout
            appris le
